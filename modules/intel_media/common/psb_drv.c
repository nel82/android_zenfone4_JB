...
#if defined(CONFIG_SUPPORT_MIPI_OTM8018B_DISPLAY)||defined(CONFIG_SUPPORT_MIPI_HX8379A_DISPLAY)
...
#ifdef CONFIG_SUPPORT_MIPI_NT35521_DISPLAY
#ifdef ASUS_PROJECT_ME372CL_DISPLAY
extern struct platform_driver nt35521_vid_lcd_driver;
extern struct platform_driver nt35521_vid_lcd_driver_for_cl_evb;
#else
extern struct platform_driver nt35521_vid_lcd_driver;
#endif
#endif

#ifdef CONFIG_SUPPORT_MIPI_B101UAN017_DISPLAY
extern struct platform_driver b101uan017_vid_lcd_driver;
#endif

#ifdef CONFIG_SUPPORT_MIPI_SN65DSI86_BRIDGE
extern struct platform_driver sn65dsi86_vid_lcd_driver;
#endif

#ifdef CONFIG_SUPPORT_MIPI_OTM8018B_DISPLAY
extern struct platform_driver otm8018b_vid_lcd_driver;
#endif
				 ...
				 struct drm_file *file_priv)
{
	...
	if (arg->vsync_operation_mask) {
		...
		if (arg->vsync_operation_mask & VSYNC_RESET_PANEL) {
...
static int __init psb_init(void)
{
	...
	if(Read_HW_ID() == HW_ID_SR1)
		ret = platform_driver_register(&nt35521_vid_lcd_driver_for_cl_evb);
	else
		ret = platform_driver_register(&nt35521_vid_lcd_driver);
#else
	ret = platform_driver_register(&nt35521_vid_lcd_driver);
#endif
#endif
...
#ifdef CONFIG_SUPPORT_MIPI_B101UAN017_DISPLAY
	ret = platform_driver_register(&b101uan017_vid_lcd_driver);
#endif

#ifdef CONFIG_SUPPORT_MIPI_SN65DSI86_BRIDGE
	ret = platform_driver_register(&sn65dsi86_vid_lcd_driver);
#endif

#ifdef CONFIG_SUPPORT_MIPI_OTM8018B_DISPLAY
	ret = platform_driver_register(&otm8018b_vid_lcd_driver);
#endif
#ifdef CONFIG_SUPPORT_MIPI_HX8379A_DISPLAY
